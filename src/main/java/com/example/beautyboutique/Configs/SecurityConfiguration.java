        ...
        http
                ...
                .authorizeHttpRequests(requests ->
                        ...
                        requests
                                ...
                                .requestMatchers("/api/voucher/save-voucher-for-user").hasRole("USER")
                                ...
                                .requestMatchers("/api/order/order-histories").permitAll()
                                .requestMatchers("/api/order/create-payment").permitAll()
                                .requestMatchers("/api/order/create-order").permitAll()
                                .requestMatchers("/api/order/update-order").permitAll()
                                .requestMatchers("/api/order/cancel-order").permitAll()
